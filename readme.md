...
## Reporte de Ingeniería: Decisiones de Diseño y Auditoría
...
* **Reconstrucción Automática de Padding:** Base64URL le quita los caracteres `=` al token. Como Python exige que los bytes sean múltiplos de 4, implementamos un parche aritmético manual usando el operador módulo (`4 - len(partes[1]) % 4`). Al atrapar esto con control de excepciones, evitamos que un token corrupto inyectado tire la app por un error de parsing.
...
* [Avances y Traza de Red — Semana 1](./semana-1/README.md)
* [Avances y Validadores de Cliente — Semana 2](./semana-2/README.md)
* [Documentación de Monitoreo SSE — Semana 6](./semana6/README.md)
* [Dilemas de Conexión y Multiplexación — Semana 7 (Retos 1 y 3)](./seamana7/README.md)
* [Estrategias de Parser y Flujo SSE — Semana 7 (Reto 2)](./seamana7%20retoia2/README.md)
* [Ciclo de Vida y Seguridad del Token — Semana 9](./semana9/README.md)


## Requisitos y Setup rápido
* Python 3.10 o superior
* Paquetes básicos de entorno:
```bash
